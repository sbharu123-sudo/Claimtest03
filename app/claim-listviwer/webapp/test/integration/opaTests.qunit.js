...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "claimlistviwer/test/integration/ClaimsListJourney.gen",
    "claimlistviwer/test/integration/ClaimsObjectPageJourney.gen",
    "claimlistviwer/test/integration/LosstypesObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
